    ...
    <nav :class="{show: isActive}">
      <ul>
        ...
        <li class="contact">
          ...
          <a
            class="contact-email"
            href="mailto:hello@nickjohn.co.uk?subject=Hello%20NJ%2C%20I'm%20diggin'%20ya%20portfolio!&body="
          >hello@nickjohn.co.uk</a>
          <div class="contact-socials">
            <a href="https://github.com/nickthegit" target="_blank">
              <github/>
            </a>
            <a href="https://codepen.io/jonserness/" target="_blank">
              <codepen/>
            </a>
            <a href="https://www.linkedin.com/in/nick-john-a310a753/" target="_blank">
              <linkedin/>
            </a>
          </div>
        </li>
